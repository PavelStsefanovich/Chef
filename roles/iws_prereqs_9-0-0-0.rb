name 'iws_prereqs_9-0-0-0'
description '<<< IWS 9.0.0.0 Prerequisites >>>
	- Winodws Features:
		-- IIS ASP.NET,
		-- IIS ASP.NET 4.5,
		-- IIS ASP,
	...
	- ASP.NET AJAX (1.0);
	- ASP.NET MVC (4);
	- Microsoft .NET Core - Windows Server Hosting (2.1.7);
...
common_run_list = [
	...
	"recipe[windows_server_hosting::install_server_hosting_2]",
