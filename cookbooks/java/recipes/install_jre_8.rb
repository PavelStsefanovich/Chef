...
puts " - initializing: [java::install_jre_8]"
...
version_dir = node["java"][8]["jre"]["major_version_directory"]
packagefile = node["java"][8]["jre"]["packagefile"]
installname = node["java"][8]["jre"]["installname"]
arguments = node["java"][8]["jre"]["arguments"]
setJavaHome = node["java"][8]["jre"]["setJavaHome"]
