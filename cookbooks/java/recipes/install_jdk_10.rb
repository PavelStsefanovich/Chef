...
puts " - initializing: [java::install_jdk_10]"
...
version_dir = node["java"][10]["jdk"]["major_version_directory"]
packagefile = node["java"][10]["jdk"]["packagefile"]
installname = node["java"][10]["jdk"]["installname"]
arguments = node["java"][10]["jdk"]["arguments"]
setJavaHome = node["java"][10]["jdk"]["setJavaHome"]
