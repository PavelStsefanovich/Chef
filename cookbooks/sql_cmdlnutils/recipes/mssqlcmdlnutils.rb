...
puts " - initializing: [sql_cmdlnutils::mssqlcmdlnutils.rb]"
...
packagefile = node["sql_cmdlnutils"]["mssqlcmdlnutils"]["packagefile"]
installname = node["sql_cmdlnutils"]["mssqlcmdlnutils"]["installname"]
arguments = node["sql_cmdlnutils"]["mssqlcmdlnutils"]["arguments"]
