...
puts " - initializing: [sql_cmdlnutils::install_msodbcsql_13]"
...
version_dir = node["sql_cmdlnutils"][13]["msodbcsql"]["major_version_directory"]
packagefile = node["sql_cmdlnutils"][13]["msodbcsql"]["packagefile"]
installname = node["sql_cmdlnutils"][13]["msodbcsql"]["installname"]
arguments = node["sql_cmdlnutils"][13]["msodbcsql"]["arguments"]
