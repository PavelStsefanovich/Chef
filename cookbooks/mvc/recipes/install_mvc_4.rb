...
puts " - initializing: [mvc::install_mvc_4]"
...
version_dir = node["mvc"][4]["major_version_directory"]
packagefile = node["mvc"][4]["packagefile"]
installname = node["mvc"][4]["installname"]
arguments = node["mvc"][4]["arguments"]
