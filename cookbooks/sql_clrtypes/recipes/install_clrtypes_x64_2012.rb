...
puts " - initializing: [sql_clrtypes::install_clrtypes_x64_2012]"
...
version_dir = node["sql_clrtypes_x64"][2012]["major_version_directory"]
packagefile = node["sql_clrtypes_x64"][2012]["packagefile"]
installname = node["sql_clrtypes_x64"][2012]["installname"]
arguments = node["sql_clrtypes_x64"][2012]["arguments"]
