...
puts " - initializing: [sql_clrtypes::types2012.rb]"
...
packagefile = node["sql_clrtypes"]["types2012"]["packagefile"]
installname = node["sql_clrtypes"]["types2012"]["installname"]
arguments = node["sql_clrtypes"]["types2012"]["arguments"]
