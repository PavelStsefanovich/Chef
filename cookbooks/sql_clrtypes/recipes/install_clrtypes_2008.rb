...
puts " - initializing: [sql_clrtypes::install_clrtypes_2008]"
...
version_dir = node["sql_clrtypes"][2008]["major_version_directory"]
packagefile = node["sql_clrtypes"][2008]["packagefile"]
installname = node["sql_clrtypes"][2008]["installname"]
arguments = node["sql_clrtypes"][2008]["arguments"]
