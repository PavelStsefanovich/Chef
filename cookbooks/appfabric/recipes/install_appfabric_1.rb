...
puts " - initializing: [appfabric::install_appfabric_1]"
...
version_dir = node["appfabric"][1]["major_version_directory"]
packagefile = node["appfabric"][1]["packagefile"]
installname = node["appfabric"][1]["installname"]
arguments = node["appfabric"][1]["arguments"]
