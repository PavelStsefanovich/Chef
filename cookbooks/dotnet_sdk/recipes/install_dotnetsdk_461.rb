...
puts " - initializing: [dotnet_sdk::install_dotnetsdk_461]"
...
version_dir = node["dotnet_sdk"][461]["major_version_directory"]
packagefile = node["dotnet_sdk"][461]["packagefile"]
installname = node["dotnet_sdk"][461]["installname"]
arguments = node["dotnet_sdk"][461]["arguments"]
