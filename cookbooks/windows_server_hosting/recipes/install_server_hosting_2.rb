...
puts " - initializing: [windows_server_hosting::install_server_hosting_2]"
...
version_dir = node["windows_server_hosting"][2]["major_version_directory"]
packagefile = node["windows_server_hosting"][2]["packagefile"]
installname = node["windows_server_hosting"][2]["installname"]
arguments = node["windows_server_hosting"][2]["arguments"]
