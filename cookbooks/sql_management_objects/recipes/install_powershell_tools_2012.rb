...
puts " - initializing: [sql_management_objects::install_powershell_tools_2012]"
...
version_dir = node["sql_management_objects"][2012]["powershell_tools"]["major_version_directory"]
packagefile = node["sql_management_objects"][2012]["powershell_tools"]["packagefile"]
installname = node["sql_management_objects"][2012]["powershell_tools"]["installname"]
arguments = node["sql_management_objects"][2012]["powershell_tools"]["arguments"]
