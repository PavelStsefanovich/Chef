...
puts " - initializing: [build_tools::install_bt_2015]"
...
version_dir = node["build_tools"][2015]["major_version_directory"]
packagefile = node["build_tools"][2015]["packagefile"]
installname = node["build_tools"][2015]["installname"]
arguments = node["build_tools"][2015]["arguments"]
